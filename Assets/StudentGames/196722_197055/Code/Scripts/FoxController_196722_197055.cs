...
public class FoxController_196722_197055 : MonoBehaviour
{
    ...
    private void Attack()
    {
        ...
        foreach (var hit in hits)
        {
            if (hit.CompareTag("Enemy"))
            {
                ...
                EnemyController_196722_197055 enemyScript = enemyGameObject.GetComponent<EnemyController_196722_197055>();
            ...
            {
                GameObject enemyGameObject = hit.gameObject;
                BearController_196722_197055 enemyScript = enemyGameObject.GetComponent<BearController_196722_197055>();
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        ...
        else if (other.CompareTag("BossDoor"))
        {
            ...
            else if(GameManager.instance.GetNumberOfKeysFound() < keysNumber)
            {
                GameManager.instance.NotEnoughKeys();
            }
        }
        else if (other.CompareTag("BossStarter"))
        {
            ...
            GameManager.instance.Enoughkeys();
